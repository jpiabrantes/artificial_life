...
from algorithms.central_ppo.sampler import Sampler
from algorithms.central_ppo.trainer import Trainer
...
class CentralPPOTrainer:
        ...
        with tf.device('/cpu:0'):
            ...
            for epoch in range(epochs):
                ...
                for species_index, variables in species_buffers.items():
                    ...
                    training_results.append(self.trainers[i].train.remote(weights[species_index], variables,
                                                                          species_index))
    ...
    def _concatenate_samplers_results(self, species_dict_list, ext_species_buffers):
        ...
        """
        assert len(species_dict_list) == self.n_workers
