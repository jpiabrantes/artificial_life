...
from utils.buffers import VDNReplayBuffer
...
class DQN_trainer:
    def __init__(self, env_creator,  brain_creator, population_size, batch_size=32, update_freq=4, gamma=0.99,
        ...
        species_dict = {species_index: {'steps': 0, 'last_update': 0, 'eps': start_eps, 'buffer': VDNReplayBuffer(),
        ...
        total_steps = 0
        while True:
            episode_buffers = {species_index: VDNReplayBuffer() for species_index in species_indices}
